...
| 4 | Adaptive progression (M5) | `checkpoints/checkpoint_4_*_report.md`; `src/module5_adaptive_progression/`; `integration_tests/module5_integration/` |
